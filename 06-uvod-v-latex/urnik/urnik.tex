...
% Besede `\texttt{bool}`, `true`, `false` v spodnjem odstavku naj bodo napisane v pisavi 
% za izvorno kodo.
...
(skoraj) vedno \enquote{odločil}, da jih ne bo prekršil. Tak način uteževanja pride v poštev
...
kakovost urnika:
\[ 
   k_1 \cdot u_1 + k_2 \cdot u_2 + \dots + k_{n-1} \cdot
u_{n-1} + k_n \cdot u_n 
\]
...
Sledili smo receptu in s tem izdelali \enquote{okusen obrok}, treba ga je le še ustrezno postreči
